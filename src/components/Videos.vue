  ...
  <div>
    ...
    <ul class="videos">
      <li v-for="video in videos">
        <a class="video" v-bind:href="video.href" v-on:click.prevent="currentVideo=video.href; showVideoModal=true">
          <img v-bind:src="video.poster" v-bind:alt="video.title"/>
          <h3>{{video.title}}</h3>
        </a>
      </li>
    </ul>
